...
public:
    ...
    void setupUi(QMainWindow *gestion_mahdi)
    {
        ...
        tabWidget->setGeometry(QRect(50, 20, 731, 441));
        ...
        pushButton->setGeometry(QRect(80, 460, 651, 28));
    ...
    void retranslateUi(QMainWindow *gestion_mahdi)
    {
        ...
        pushButton->setText(QApplication::translate("gestion_mahdi", "menu principal", Q_NULLPTR));
    } // retranslateUi
