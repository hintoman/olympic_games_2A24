...
struct qt_meta_stringdata_maps_t {
    QByteArrayData data[1];
    char stringdata0[5];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_maps_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_maps_t qt_meta_stringdata_maps = {
    {
QT_MOC_LITERAL(0, 0, 4) // "maps"
...
const QMetaObject maps::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_maps.data,
      qt_meta_data_maps,  qt_static_metacall, nullptr, nullptr}
};
...
void *maps::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_maps.stringdata0))
