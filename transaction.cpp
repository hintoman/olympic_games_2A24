...
QSqlQueryModel * Transaction:: tri(){
    QSqlQueryModel * model= new QSqlQueryModel();
       ...
       model->setQuery("select * from transaction ORDER BY type DESC");
       model-> setHeaderData(0,Qt:: Horizontal,QObject::tr("id"));
       model-> setHeaderData(1,Qt:: Horizontal,QObject::tr("type"));
       model-> setHeaderData(2,Qt:: Horizontal,QObject::tr("montant"));
       model-> setHeaderData(3,Qt:: Horizontal,QObject::tr("datet"));
...
QSqlQueryModel * Transaction:: trm(){
    QSqlQueryModel * model= new QSqlQueryModel();
                            ...
                            model->setQuery("select * from transaction ORDER BY montant ");
                            model-> setHeaderData(0,Qt:: Horizontal,QObject::tr("id"));
                            model-> setHeaderData(1,Qt:: Horizontal,QObject::tr("type"));
                            model-> setHeaderData(2,Qt:: Horizontal,QObject::tr("montant"));
                            model-> setHeaderData(3,Qt:: Horizontal,QObject::tr("datet"));
...
QSqlQueryModel * Transaction::trd(){
    QSqlQueryModel * model= new QSqlQueryModel();
       ...
       model->setQuery("select * from transaction ORDER BY datet ");
       model-> setHeaderData(0,Qt:: Horizontal,QObject::tr("id"));
       model-> setHeaderData(1,Qt:: Horizontal,QObject::tr("type"));
       model-> setHeaderData(2,Qt:: Horizontal,QObject::tr("montant"));
       model-> setHeaderData(3,Qt:: Horizontal,QObject::tr("datet"));
...
QSqlQueryModel * Transaction:: calculF(){
    QSqlQueryModel * model= new QSqlQueryModel();
    model->setQuery("select * from transaction sum  montant where datet =:datet");
