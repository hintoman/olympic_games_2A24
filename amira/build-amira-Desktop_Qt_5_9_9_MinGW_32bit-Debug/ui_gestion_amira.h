...
public:
    ...
    void setupUi(QMainWindow *gestion_amira)
    {
        ...
        tabWidget->setGeometry(QRect(30, 20, 711, 441));
        ...
        pushButton_2->setGeometry(QRect(70, 460, 651, 28));
    ...
    void retranslateUi(QMainWindow *gestion_amira)
    {
        ...
        pushButton_2->setText(QApplication::translate("gestion_amira", "menu principal", Q_NULLPTR));
